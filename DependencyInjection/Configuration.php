            ...
            ->children()
                ->arrayNode('messenger')
                    ...
                    ->children()
                        ...
                        ->arrayNode('new_message')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type_class')->cannotBeEmpty()->defaultValue('Fulgurio\SocialNetworkBundle\Form\Type\Messenger\NewMessageFormType')->end()
                            ->end()
                            ->children()
                                ->scalarNode('handler_class')->cannotBeEmpty()->defaultValue('Fulgurio\SocialNetworkBundle\Form\Handler\Messenger\NewMessageFormHandler')->end()
                            ->end()
                        ->end()
                        ->arrayNode('answer_message')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type_class')->cannotBeEmpty()->defaultValue('Fulgurio\SocialNetworkBundle\Form\Type\Messenger\AnswerMessageFormType')->end()
                            ->end()
                            ->children()
                                ->scalarNode('handler_class')->cannotBeEmpty()->defaultValue('Fulgurio\SocialNetworkBundle\Form\Handler\Messenger\AnswerMessageFormHandler')->end()
                            ->end()
                        ->end()
                        ->arrayNode('message')
                            ->addDefaultsIfNotSet()
